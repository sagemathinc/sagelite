...
| Linux aarch64 | 3.14 | missing; first native `post33` build exposed a stale cross-Python cached configuration and failed before producing wheels; corrected exact-SHA rebuild active | none; no wheel or validation result claimed yet | none |

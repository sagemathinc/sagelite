...
class ReginaElement(ExtraTabCompletion, InterfaceElement):
    ...
    def __getattr__(self, attrname):
        ...
        EXAMPLES::
            ...
            <bound method pybind11_detail_function_record_v1_system_...detail of <regina.AbelianGroup: 0>>
        """
        P = self._check_valid()
        if attrname == '_inst':
...
class ReginaFunctionElement(InterfaceFunctionElement):
    ...
    EXAMPLES::
        ...
        sage: A.addRank
        <bound method pybind11_detail_function_record_v1_system_...addRank of <regina.AbelianGroup: 0>>
        sage: type(A.addRank)
        <class 'sage.interfaces.regina.ReginaFunctionElement'>
    """

...
TARGETS_PRE="${TARGETS_PRE:-gmp mpfr mpc openblas gsl libgd pari flint m4ri m4rie ecm fflas_ffpack linbox gap singular bliss coxeter3 mcqd meataxe sirocco tdlib}"
